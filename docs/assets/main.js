...
const app = createApp({
  setup() {
    ...
    const updateBundleSearch = debounce((val) => {
      bundleSearch.value = val;
    }, 150);
    const updateAppSearch = debounce((val) => {
      appSearch.value = val;
    }, 150);
    const updatePopupSearchQuery = debounce((val) => {
      popupSearchQuery.value = val;
    }, 200);
    const updatePopupAppSearch = debounce((val) => {
